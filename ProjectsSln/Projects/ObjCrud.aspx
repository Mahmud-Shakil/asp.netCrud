<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ObjCrud.aspx.cs" Inherits="Projects.ObjCrud" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div>
       <asp:ScriptManagerProxy ID="ScriptManagerProxy1" runat="server"></asp:ScriptManagerProxy>
                ...
                <asp:GridView ID="GridView1" DataKeyNames="CustomerId" runat="server" AutoGenerateColumns="False" DataSourceID="ObjectDataSource1" OnRowDeleting="GridView1_RowDeleting" OnRowUpdating="GridView1_RowUpdating">
           <Columns>
               ...
               <asp:TemplateField HeaderText="SupplierName" SortExpression="SupplierName">
                ...
                <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" DeleteMethod="DeleteCustomer" InsertMethod="SaveCustomer" SelectMethod="GetCustomersList" TypeName="Projects.DAL.GateWay" UpdateMethod="UpdateCustomer">
           <DeleteParameters>
